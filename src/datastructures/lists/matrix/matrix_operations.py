...
"""
print("\n----------- Examples of Matrices -------------\n")
print("\n----------- 1. Count Number of occurrence of a number in matrix -------------\n")
...
# So we will loop through each row and column of matrix and will check
...
print("Occurrences of elements in matrix using List comprehension:")
for key, val in count.items():
    print(f"{key} → {val}")

"""
Occurrences of elements in matrix using List comprehension:
1 → 1
2 → 2
3 → 2
4 → 1
...
"""
To calculate the sum of all elements of matrix we have to go through the all elements and add them
"""
sum_of_elements = 0
for row in matrix:
    for element in row:
...
print(f"The sum of all elements of matrix is =>: {sum_of_elements}")

# Using Comprehension
sum_of_elements = sum([item for row in matrix for item in row])
print(f"The sum of all elements of matrix using comprehension =>: {sum_of_elements}")
"""
The sum of all elements of matrix is =>: 45
The sum of all elements of matrix using comprehension =>: 45
"""
...
"""
# Example 5
print("\n----------- 5. Print the max and min element in matrix. -------------\n")
...
print(f"Max element of the matrix is =>: {max_element}")
print(f"Min element of the matrix is =>: {min_element}")

"""
Max element of the matrix is =>: 8
Min element of the matrix is =>: 1
"""
...
print(f"Number of Even element of the matrix is =>: {even_odd_dict['even']}")
print(f"Number of Odd element of the matrix is =>: {even_odd_dict['odd']}")
print(f"Even elements of the matrix is =>: {even_numbers}")
print(f"Even elements of the matrix is =>: {odd_numbers}")

# Example 7
print("\n----------- Advance  -------------\n")
print("\n----------- 7. Transpose a matrix like convert rows to columns and vice versa -------------\n")
...
2. Find no. of rows and cols in original matrix
3. Add outer loop on cols because we will flip the matrix so original's matrix cols will be rows
4. Add inner loop on rows because we will flip the matrix so original's matrix rows will be columns
